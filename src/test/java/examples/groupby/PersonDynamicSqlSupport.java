...
public class PersonDynamicSqlSupport {
    ...
    public static final class Person extends SqlTable {
        ...
        public SqlColumn<Integer> id = column("person_id", JDBCType.INTEGER);
        ...
        public SqlColumn<String> gender = column("gender", JDBCType.VARCHAR);
        public SqlColumn<String> human = column("human_flag", JDBCType.VARCHAR);
        public SqlColumn<Integer> age = column("age", JDBCType.INTEGER);
    }
}
