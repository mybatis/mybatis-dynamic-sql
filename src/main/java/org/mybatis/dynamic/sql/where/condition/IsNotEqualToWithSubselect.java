...
public class IsNotEqualToWithSubselect<T> extends AbstractSubselectCondition<T> {
    ...
    protected IsNotEqualToWithSubselect(SelectModelBuilder.Buildable selectModelBuilder) {
        super(selectModelBuilder);
    }

    public static <T> IsNotEqualToWithSubselect<T> of(SelectModelBuilder.Buildable selectModelBuilder) {
