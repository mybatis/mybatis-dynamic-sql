...
public abstract class AbstractQueryingDSL {
    ...
    private final List<AbstractJoinSpecificationFinisher<?, ?>> joinSpecifications = new ArrayList<>();
    ...
    protected void addJoinSpecification(AbstractJoinSpecificationFinisher<?, ?> joinSpecification) {
