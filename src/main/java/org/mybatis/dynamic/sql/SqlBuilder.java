...
import org.mybatis.dynamic.sql.select.function.Modulo;
...
public interface SqlBuilder {
    ...
    static <T extends Number> Modulo<T> modulo(BindableColumn<T> firstColumn, Integer modulo) {
        return Modulo.of(firstColumn, modulo);
    }
