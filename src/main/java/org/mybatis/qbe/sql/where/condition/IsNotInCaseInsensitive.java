...
public class IsNotInCaseInsensitive extends ListValueCondition<String> {

    protected IsNotInCaseInsensitive(Stream<String> values) {
        super(values);
    }
    
    @Override
    public String render(String columnName, Stream<String> placeholders) {
        return String.format("upper(%s) %s", columnName, //$NON-NLS-1$
                placeholders
